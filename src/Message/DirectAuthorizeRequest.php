...
class DirectAuthorizeRequest extends AbstractRequest
{
    ...
    protected function getBaseAuthorizeData()
    {
        ...
        $data['BrowserAcceptHeader'] = isset($_SERVER['HTTP_ACCEPT']) ? $_SERVER['HTTP_ACCEPT'] : null;
        $data['BrowserUserAgent'] = isset($_SERVER['HTTP_USER_AGENT']) ? $_SERVER['HTTP_USER_AGENT'] : null;
